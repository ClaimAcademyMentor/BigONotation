...
public class BigOMain {
	...
	public static void main(String[] args) {
		...
		// O(1) Notation - Describes an algorithm that will always execute in the same space/time regardless of size
		String ex1 = "A";
		...
		String ex3 = "Better known for literary masterpieces such as A Farewell to Arms and The Old Man and the Sea, Ernest Hemingway was born in 1899 and went on to win the Nobel Prize for Literature in 1954. Whilst in later years he gained the reputation as an avid hunter and inveterate drinker, Hemingway wrote a great deal of poetry, especially in his youth.\r\n"
				...
				+ "\r\n"
				+ "\r\n"
				+ "In 1961, at the age of 61, Hemingway took one of his shot guns from the cellar and shot himself in his Ketchum home. He was buried above Trail Creek in Idaho.";
...
//		}
		...
		// O(log N) Dealing with logarithmic time. The program will adjust and increase with the size of the input
		...
		for (int i = 1; i < chEx1.length; i = i*2) {
			countBT++;
			System.out.println("Loop is at " + i + " Current Character is " + chEx1[i] + " counted actually at this point " + countBT);
		}
